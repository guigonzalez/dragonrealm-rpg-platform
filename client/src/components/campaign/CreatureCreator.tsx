    ...
    try {
      ...
      toast({
        ...
        description: actualCampaignId 
          ? "A criatura foi gerada utilizando o contexto da sua campanha. Os campos foram preenchidos automaticamente." 
              ...
              {actualCampaignId && (
                <div className="flex items-start gap-2 p-3 rounded-md bg-primary/10 mb-4">
                  ...
                  <div className="flex-1">
                    <p className="text-sm font-medium">Usando dados da campanha para gerar a criatura</p>
                    <p className="text-xs text-muted-foreground">
                      A IA usará a construção de mundo, NPCs existentes e localizações da sua campanha para criar uma criatura contextualizada.
                    </p>
                  </div>
                </div>
              )}
